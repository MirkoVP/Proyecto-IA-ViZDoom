...
old_save = True
old_dir_dqn = "/home/mirko/VizDoomAgents/vizdoom/trains/corridor/dqn-stop-2"
old_dir_ppo = "/home/mirko/VizDoomAgents/vizdoom/trains/corridor/ppo-stop-4-1"
...
class RewardShapingWrapper(RewardWrapper):
    def __init__(self, env, damage_reward=50, hit_taken_penalty=-25, kill_reward = 150.0, ammo_penalty=-50, step_penalty=-1.0):
    ...
    def reward(self, reward):
        ...
        if game_state:
            ...
            if current_killcount > self.previous_killcount:
                delta = current_killcount - self.previous_killcount
                custom_reward += delta * self.kill_reward
            self.previous_killcount = current_killcount

            # Penalización por paso quieto
...
if __name__ == "__main__":
    ...
    for model in MODEL_LIST:
        for map_name, env_name in zip(MAP_LIST[start_index:], ENV_LIST[start_index:]):
            LOG_DIR = f"/home/mirko/VizDoomAgents/vizdoom/trains/{map_name}/{model}-{num}"
