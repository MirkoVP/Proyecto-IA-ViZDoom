...
MODEL_PATHS = {
    ...
    "dqn": {"model": "best_model", "num": "Seba-v3-3", "subfolder": "models"},  # dqn usa "best_model" en la subcarpeta "models"
    "ppo": {"model": "best_model", "num": "Seba-v3-3", "subfolder": "models"}   # ppo usa "best_model" en la subcarpeta "models"
}
